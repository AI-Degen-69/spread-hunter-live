...
read stay in core_brain.order_manager next to the CLI verbs that use them.

Extracted from core_brain.order_manager (Session 62-era code, previously the one
