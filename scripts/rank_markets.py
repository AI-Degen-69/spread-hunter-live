...
(C:/Users/Tiger/Agents/Projects/AI Trading/spread-hunter/scripts/rank_markets.py)
into this standalone repo. All paths are relative to THIS repo (run/markets.json
etc. are written here); the strategy.* scoring modules it imports live in
strategy/ in this repo. Keep in sync with the simulation copy.
